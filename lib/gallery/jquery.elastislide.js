	...
	$.elastislide.prototype 	= {
		...
		_setDim				: function( elW ) {
			...
			this.$items.css({
				...
				height		: ( elW ) ? elW : this.options.imageH + 2 * this.options.border
		...
		_addControls		: function() {
			this.$navNext	= $('<span class="fa fa-chevron-right es-nav-next"></span>');
			this.$navPrev	= $('<span class="fa fa-chevron-left es-nav-prev"></span>');
			$('<div class="es-nav"/>')
			.append( this.$navPrev )
			.append( this.$navNext )
			.appendTo( this.$el );
		...
		_reload				: function() {
			...
			if( instance.visibleWidth < instance.options.minItems * ( instance.options.imageH + 2 * instance.options.border ) + ( instance.options.minItems - 1 ) * instance.options.margin ) {
