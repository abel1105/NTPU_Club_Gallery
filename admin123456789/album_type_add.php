      ...
      <div class="content container">
        <div class="row">
          <div class="col-md-12">
            <div class="widget">
              <table width="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    <p>現在位置：
                      <? echo $row_result_func1['ct_name'] ." > ". $row_result_func1['c_name'] ." > 新增相簿"; ?>
                    </p>
                  </td>
                </tr>
              </table>
            ...
            <div class="widget">
              <form action="" method="post" name="addalbum_form" onsubmit="return check_form_album_add();">
                <div class="css_table">
                  <div class="css_table">
                    <div class="css_td" style="width: 20%; text-align:right;">相簿名：</div>
                    <div class="css_td" style="width: 80%; text-align:left;">
                      <input name="at_name" type="text" id="at_name" size="40" required/>
                    </div>
                  </div>
                  <div class="css_table">
                    <div class="css_td" style="width: 20%; text-align:right;">社團名稱：</div>
                    <div class="css_td" style="width: 80% text-align:left;">
                      <input type="text" size="40" name="at_club" id="at_club" value="<?echo $row_result_func1['c_name']; ?>" readonly/>
                  ...
                  <div class="css_table">
                    ...
                    <div class="css_td" style="width: 80% text-align:left;">
                      <input type="text" size="5" name="club_number" id="club_number" value="<?echo $row_result_func1['c_number']; ?>" readonly/>
                      <span class="warn">禁止更改</span>
                    </div>
                  </div>
                  <div class="css_table">
                    ...
                    <div class="css_td" style="width: 80% text-align:left;">
                      <input size="5" name="sort" type="text" id="sort" value="0" size="10" />
                  ...
                  <div class="css_table">
                    ...
                    <div class="css_td" style="width: 80% text-align:left;">
                      <input name="at_info" type="text" id="at_info" size="60" />
                    </div>
                  </div>
                  <div class="css_table">
                    <div class="css_td" style="width: 20%; text-align:right;">功能：</div>
                    <div class="css_td" style="width: 80% text-align:left;">
                      <input class="s_button" name="add" type="submit" id="add" value="新增" title="新增此筆資料" />
                      &nbsp;&nbsp;
